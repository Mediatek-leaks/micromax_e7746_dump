...
#prize liaoxingen modify start
BOOT_LOGO = fhdplus2400
#prize liaoxingen modify end
BUILD_AGO_GMS = no
BUILD_KERNEL = yes
BUILD_LK = yes
BUILD_MD32 = no
...
CUSTOM_HAL_IMGSENSOR = s5kgm1st_mipi_raw ov16a10_mipi_raw ov16a1q_mipi_raw bf2253Lmacro_mipi_raw bf2253L_mipi_raw gc5035_mipi_raw gc8034sub_mipi_raw
CUSTOM_HAL_MAIN2_IMGSENSOR =
#CUSTOM_HAL_MAIN_IMGSENSOR = imx519_mipi_raw
CUSTOM_HAL_MAIN_IMGSENSOR = s5kgm1st_mipi_raw
#prize modify by zhuzhengjiang for camera 20200902 end
#prize-modify MSENSORLIB is QstAlgo, pzp 20200829-start
CUSTOM_HAL_MSENSORLIB = QstAlgo
#prize-modify MSENSORLIB is QstAlgo, pzp 20200829-end
CUSTOM_HAL_SENSORS = sensor
#prize modify by zhuzhengjiang for camera 20200902 start
#CUSTOM_HAL_SUB_IMGSENSOR = s5k2t7sp_mipi_raw
CUSTOM_HAL_SUB_IMGSENSOR = ov16a1q_mipi_raw
#prize modify by zhuzhengjiang for camera 20200902 end
...
#prize liaoxingen modify 20200831 start
CUSTOM_KERNEL_BAROMETER = no 
#prize liaoxingen modify 20200831 end
...
CUSTOM_KERNEL_IMGSENSOR = s5kgm1st_mipi_raw ov16a10_mipi_raw ov16a1q_mipi_raw bf2253Lmacro_mipi_raw bf2253L_mipi_raw gc5035_mipi_raw gc8034sub_mipi_raw
#prize modify by zhuzhengjiang for camera 20200902 end
...
CUSTOM_KERNEL_MAIN_IMGSENSOR = s5kgm1st_mipi_raw
#prize modify by zhuzhengjiang for camera 20200902 end
...
CUSTOM_KERNEL_SUB_IMGSENSOR = ov16a1q_mipi_raw
#prize modify by zhuzhengjiang for camera 20200902 end
...
CUSTOM_MODEM=k6601q-LWCTG_6769-4M-G4W158F13578T4041-V0.1
...
#prize-add-pengzhipeng-20200903-start
MICROTRUST_TEE_SUPPORT = yes
PRIZE_TEE_FACE_ID = yes
#prize-add-pengzhipeng-20200903-end
MNTL_SUPPORT = no
...
MTK_ATF_SUPPORT = yes
MTK_AUDIO = yes
# prize modify by liaoxingen for handsfree echo 20200929 start
MTK_AUDIODSP_SUPPORT = no
# prize modify by liaoxingen for handsfree echo 20200929 end
...
# prize liaoxingen modify smartpa path 20200831 start
MTK_AUDIO_SPEAKER_PATH = smartpa_awinic_aw881xx
# prize liaoxingen modify smartpa path 20200831 end
...
#prize liaoxingen modify for camera start
MTK_CAM_MAX_NUMBER_OF_CAMERA = 5
#prize liaoxingen modify for camera end
...
#prize modify by zhuzhengjiang for dual camera 20200915 start
...
#prize modify by zhuzhengjiang for dual camera 20200915 end
...
#prize liaoxingen modify 4M start
MTK_PROTOCOL1_RAT_CONFIG = Lf/Lt/W/G
#prize liaoxingen modify 4M end
...
# prize liaoxingen modify SIM HOT 20200827 start
MTK_SIM_HOT_SWAP_COMMON_SLOT = yes
# prize liaoxingen modify 20200827 end
...
PRIZE_FUNCTION_KEY    =ASSIST
#工厂测试是否显示语言切换按钮
PRIZE_DEL_LAN_SWITCH_BTN =yes
#工厂测试应用默认英语
PRIZE_FACTORYTEST_DEFAULT_LANGUAGE_EN=yes
...
#频段配置根据 MTK_PROTOCOL1_RAT_CONFIG 系统频段配置
PRIZE_BOARD_NETWORK_TYPE = GB/WB/LtB/LfB
...
PRIZE_FACTORY_TEST_REAR_CAMERA_SUB3=yes
